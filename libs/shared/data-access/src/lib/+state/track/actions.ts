...
export const TrackActions = createActionGroup({
  ...
  events: {
    ...
    'Get Lyrics': props<{ id: number; trackId: number }>(),
    'Get Lyrics Success': props<{ id: number; trackId: number; lyrics: string }>(),
    'Get Lyrics Error': props<{ id: number; trackId: number; error: string }>(),
