...
export const playerFeature = createFeature({
  ...
  reducer: createReducer(
    ...
    on(PlayerActions.updateItem, PlayerActions.getCoverSuccess, PlayerActions.getCoverError, PlayerActions.playError, (state, { update }) => adapter.updateOne(update, state)),
