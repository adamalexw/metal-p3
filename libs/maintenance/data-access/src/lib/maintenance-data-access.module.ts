...
@NgModule({
  imports: [CommonModule, SharedFeedbackModule, SharedErrorModule, StoreModule.forFeature(MAINTENANCE_FEATURE_KEY, reducer), EffectsModule.forFeature([MaintenanceEffects])],
})
