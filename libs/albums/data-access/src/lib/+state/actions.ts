...
export const loadAlbums = createAction('[Albums] Load Albums', props<{ request: Partial<SearchRequest> | undefined }>());
...
export const renameTracks = createAction('[Albums] Rename Tracks', props<{ id: number }>());
export const renameTracksSuccess = createAction('[Albums] Rename Tracks Success', props<{ update: Update<Album> }>());
