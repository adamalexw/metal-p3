...
import { ApplyLyrics, BASE_PATH, SearchRequest } from '@metal-p3/albums/domain';
import { AlbumDto, BandDto, BandProps, MetalArchivesSearchResponse, Track } from '@metal-p3/api-interfaces';
